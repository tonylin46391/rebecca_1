  ...
  return (
    <div className="min-h-screen bg-gray-100 flex">
      ...
      <div className="flex-1 flex flex-col">
        ...
        <header className="bg-white shadow-sm p-4">
          <div className="max-w-4xl mx-auto flex items-center justify-between">
            ...
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 bg-black text-white rounded-lg hover:bg-gray-800 transition-all shadow-md"
            >
              <BarChart3 size={20} />
        ...
        {/* Message Display */}
        {lastMessage && (
          <div className={`max-w-4xl mx-auto w-full mt-2 p-2 rounded-lg border-l-4 ${
        ...
        <main className="flex-1 flex items-center justify-center p-3">
          <div className="max-w-4xl w-full bg-white rounded-2xl shadow-xl p-4">
            {/* Sentence Display */}
            ...
            <div className="mt-1 space-y-1 text-black font-bold">
